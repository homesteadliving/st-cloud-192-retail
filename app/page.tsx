...
export default function Home() {
  return <>
    ...
    <main>
      ...
      <section className="aerialFeature"><img src="/st-cloud-arrival-render.webp" alt="Concept rendering of the St. Cloud retail center with tropical landscaping"/><div className="imageCaption"><span>01</span> A TROPICAL ARRIVAL ON US‑192</div></section>
