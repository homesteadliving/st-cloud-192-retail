...
export default function Home() {
  return <>
    ...
    <main>
      ...
      <section className="aerialFeature"><img src="/st-cloud-arrival-render-v3.png" alt="Plan-accurate concept rendering of The Shoppes at St. Cloud with tropical landscaping"/><div className="imageCaption"><span>01</span> A TROPICAL ARRIVAL ON US‑192</div></section>
