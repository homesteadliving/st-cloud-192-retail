...
export default function Home() {
  return <>
    <header className="nav" id="top">
      <a className="brand" href="#top" aria-label="The Shoppes at St. Cloud home"><span className="brandMark">S</span><span><strong>THE SHOPPES</strong><small>AT ST. CLOUD</small></span></a>
    ...
    <main>
      ...
      <section className="aerialFeature"><img src="/st-cloud-arrival-render-v2.webp" alt="Plan-accurate concept rendering of The Shoppes at St. Cloud with tropical landscaping"/><div className="imageCaption"><span>01</span> A TROPICAL ARRIVAL ON US‑192</div></section>
      ...
      <section className="location" id="location"><div className="locationImage"><img src="/st-cloud-aerial-render-v2.webp" alt="Plan-accurate aerial concept rendering of the two-building St. Cloud retail development"/><span className="sunSeal">SUNSHINE<br/>MEETS<br/>OPPORTUNITY</span></div><div className="locationCopy"><div className="eyebrow light">THE LOCATION</div><h2>Connected to<br/><em>everyday escape.</em></h2><p>US‑192 connects a fast-growing residential trade area with Kissimmee, Lake Nona and the greater Southeast Orlando market—bringing daily convenience into the path of a dynamic regional destination.</p><dl><div><dt>102,293</dt><dd>5-mile population</dd></div><div><dt>2.64%</dt><dd>annual growth</dd></div><div><dt>$89,747</dt><dd>median household income</dd></div><div><dt>85,481</dt><dd>daytime population</dd></div></dl><small>2025 estimates / 2030 projection. Source: SRS / Esri.</small></div></section>
      <section className="strategy section" aria-labelledby="strategy-title"><div className="strategyHead"><div><div className="eyebrow">STRATEGIC LOCATION</div><h2 id="strategy-title">In the path of<br/><em>what&apos;s next.</em></h2></div><p>Positioned on US‑192 within St. Cloud&apos;s established retail corridor and surrounded by continued residential growth.</p></div><div className="strategyMap"><img src="/strategic-location.webp" alt="Zoomed-out trade area map showing The Shoppes at St. Cloud on US-192 and surrounding growth"/></div></section>
      <section className="retail section"><div className="eyebrow">THE TRADE AREA</div><h2>National names.<br/><em>Florida momentum.</em></h2><div className="retailGrid"><p>The site sits among established daily-needs, dining and service destinations, including Publix, Wawa, Starbucks, Ace Hardware, Mister Car Wash, Chipotle and Culver&apos;s.</p><div className="retailCards"><span>DINING</span><span>SERVICE</span><span>DAILY NEEDS</span><span>RETAIL</span></div></div></section>
      <section className="contact" id="contact"><div><div className="eyebrow light">LEASING INFORMATION</div><h2>Find your place<br/><em>in the sunshine.</em></h2><a className="brochureButton" href="/the-shoppes-at-st-cloud-brochure.pdf" download>Download SRS brochure <span aria-hidden="true">↓</span></a></div><div className="contacts"><article><span>SRS REAL ESTATE PARTNERS</span><h3>KC Herbert</h3><a href="tel:+14077571629">407.757.1629</a><a href="mailto:kc.herbert@srsre.com">kc.herbert@srsre.com</a></article><article><span>SRS REAL ESTATE PARTNERS</span><h3>Jason B. Kaiser, CCIM</h3><a href="tel:+14073103001">407.310.3001</a><a href="mailto:jason.kaiser@srsre.com">jason.kaiser@srsre.com</a></article></div></section>
    </main>
    <footer><a className="brand footerBrand" href="#top"><span className="brandMark">S</span><span><strong>THE SHOPPES</strong><small>AT ST. CLOUD</small></span></a><p>201 E 13th Street · St. Cloud, Florida 34769</p><p className="footerRight">DEVELOPMENT BY <a href="https://ironcrestcapital.com" target="_blank" rel="noopener noreferrer">IRONCREST CAPITAL</a></p><small>Information is from sources deemed reliable but is not guaranteed and is subject to change.</small></footer>
  </>;
}
